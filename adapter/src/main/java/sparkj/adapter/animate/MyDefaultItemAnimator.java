...
public class MyDefaultItemAnimator extends SimpleItemAnimator {
    ...
    protected ViewPropertyAnimator doRemoveAnimation(ViewPropertyAnimator animation) {
    ...
    protected void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        doRemoveAnimation(animation.setDuration(getRemoveDuration())).setListener(
    ...
    protected ViewPropertyAnimator doAddAnimation(ViewPropertyAnimator animation) {
        return animation.alpha(1);
    }
    ...
    protected void animateAddImpl(final RecyclerView.ViewHolder holder) {
        ...
        doAddAnimation(animation.setDuration(getAddDuration()))
    ...
    protected void endChangeAnimation(List<ChangeInfo> infoList, RecyclerView.ViewHolder item) {
